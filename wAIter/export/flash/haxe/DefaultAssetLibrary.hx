...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/restaurant.oep", __ASSET__assets_data_restaurant_oep);
		type.set ("assets/data/restaurant.oep", AssetType.TEXT);
		...
		className.set ("assets/images/set.png", __ASSET__assets_images_set_png);
		type.set ("assets/images/set.png", AssetType.IMAGE);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_restaurant_oep extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_set_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/data/restaurant.oep") #if display private #end class __ASSET__assets_data_restaurant_oep extends lime.utils.Bytes {}
...
@:image("assets/images/set.png") #if display private #end class __ASSET__assets_images_set_png extends lime.graphics.Image {}
