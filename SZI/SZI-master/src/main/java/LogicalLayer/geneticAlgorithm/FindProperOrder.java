...
import LogicalLayer.Control;
import LogicalLayer.Coordinates;
import org.jgap.*;
...
public class FindProperOrder {
        ...
        public FindProperOrder() {
            ...
            distanceMatrix = new double[allTables.size() + 1][allTables.size() + 1]; //wszystkie stoly + punkt wyjscia
            ...
            Collections.sort(allTables, new Comparator<Coordinates>() {
                public int compare(Coordinates o1, Coordinates o2) {
                    ...
                    return table1 - table2;   //wczesniej ma byc ten o nizszym numerze
                }
            });

            for(int i = 0; i < allTables.size(); i++){  //odleglosci stolikow od punktu postoju kelnera
            ...
            for(int i = 1; i <= allTables.size(); i++){ //odleglosci pomiedzy wszystkimi stolikami
...
/*  //  Wydrukuj macierz odleglosci
        ...
        public List<Integer> findProperOrder(List<Integer> tablesToGoThrow){
            ...
            try {
                ...
                System.out.println("Długosc sciezki:\n" + distance);
                return solution;
