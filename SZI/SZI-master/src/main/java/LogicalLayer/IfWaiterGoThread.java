...
import LogicalLayer.geneticAlgorithm.PathFinder;
import LogicalLayer.neuralNetwork.StayOrGo;
import java.util.*;
        ...
        while (true) {
            ...
            try {
                ...
                e.printStackTrace();
                     ...
                     //a co jak taca nie jest pusta i list gotowych posi�k�w te� nie  //Popraw
            ...
            if(ordersService.getCurrentCreatingMeals().size()>0 && ordersService.getTray().size()>0) {
                ...
                if (v >= 0.5) {
                    ...
                    if (SettingsFrame.getSelectedAlgorithms().equals("Ag"))
                    {
